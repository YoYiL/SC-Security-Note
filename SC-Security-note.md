...
- [WSL 与 VS Code 开发环境配置](#wsl-与-vs-code-开发环境配置)
  - [一、WSL 已安装工具包](#一wsl-已安装工具包)
    - [1.1 版本控制与基础工具](#11-版本控制与基础工具)
    - [1.2 以太坊/Solidity 开发工具](#12-以太坊solidity-开发工具)
    - [1.3 代码分析工具](#13-代码分析工具)
  - [二、生成 PDF 审计报告流程](#二生成-pdf-审计报告流程)
    - [2.1 准备工作](#21-准备工作)
    - [2.2 安装必要软件](#22-安装必要软件)
    - [2.3 配置模板](#23-配置模板)
    - [2.4 生成报告](#24-生成报告)
  - [三、VS Code 扩展清单](#三vs-code-扩展清单)
    - [3.1 开发辅助工具](#31-开发辅助工具)
    - [3.2 Web 开发](#32-web-开发)
    - [3.3 Solidity 智能合约开发](#33-solidity-智能合约开发)
    - [3.4 实用工具](#34-实用工具)
    - [3.5 编辑器主题](#35-编辑器主题)
  - [四、安全措施](#四安全措施)
    - [4.1 开发环境隔离](#41-开发环境隔离)
